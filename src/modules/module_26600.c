...
static const char *ST_PASS        = "supercrack1";
// hash generated using with python3 tools/metamask2supercrack.py --vault tools/2supercrack_tests/metamask2supercrack.json
