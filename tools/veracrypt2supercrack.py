...
def validate_offset(offset):
    # see also https://supercrack.net/wiki/doku.php?id=frequently_asked_questions#how_do_i_extract_the_hashes_from_veracrypt_volumes
    if offset == "bootable":
...
if __name__ == "__main__":
    parser = ArgumentParser(description="veracrypt2supercrack extraction tool")
    parser.add_argument(
        "--offset",
        default=0,
