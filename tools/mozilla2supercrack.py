...
def get_supercrack_string(mpinfos: MasterPasswordInfos) -> str:
    """
...
if __name__ == '__main__':
    usage = 'python3 mozilla2supercrack.py <profile_directory or key3/4.db file>\n'
    ...
    print(get_supercrack_string(infos))
